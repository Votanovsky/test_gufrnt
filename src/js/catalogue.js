...
import images from './catalogue__images';
...
class WebGL{
    constructor(){
        ...
        this.links = [...document.querySelectorAll('.catalogue li')];
        ...
        this.addEventListeners(document.querySelector('.catalogue'));
        this.setUpCamera();
        this.onMouseMove();
        this.createMesh();
        this.render()
    ...
    setUpCamera(){
        ...
        const canvas = document.getElementById('catalogue__canvas')
